...
pub const KWE: CurrencyId = CurrencyId::Token(TokenSymbol::KWE);
pub const RUSD: CurrencyId = CurrencyId::Token(TokenSymbol::RUSD);

parameter_types! {
	pub const GetNativeCurrencyId: CurrencyId = KWE;
}
...
pub const KWE_ERC20_ADDRESS: &str = "0x0000000000000000000000000000000001000000";
