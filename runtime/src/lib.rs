...
parameter_types! {
	...
	// pub TreasuryModuleAccount: AccountId = KweTreasuryModuleId::get().into_account();
}
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("krypto_wealth"),
	impl_name: create_runtime_str!("krypto_wealth"),
	authoring_version: 1,
	spec_version: 9,
	impl_version: 9,
...
parameter_types! {
	pub const BasicDeposit: Balance =      100 * KWE;
	pub const FieldDeposit: Balance =        1 * KWE;
	pub const SubAccountDeposit: Balance =  20 * KWE;
...
parameter_types! {
	pub const IndexDeposit: Balance = 1 * KWE;
}
...
parameter_types! {
	pub const GetNativeCurrencyId: CurrencyId = CurrencyId::Token(TokenSymbol::KWE);
...
parameter_types! {
	pub const TransactionByteFee: Balance = 10 * MILLI_KWE;
...
parameter_types! {
	...
	// 10 KWE minimum storage deposit
	pub const NewContractExtraBytes: u32 = 10_000;
	pub const StorageDepositPerByte: Balance = 1 * MILLI_KWE;
	pub const MaxCodeSize: u32 = 60 * 1024;
	pub NetworkContractSource: H160 = H160::from_low_u64_be(0);
	pub const DeveloperDeposit: Balance = 1_000 * KWE;
	pub const DeploymentFee: Balance    = 100 * KWE;
}
...
parameter_types! {
	...
	pub const NativeTokenExistentialDeposit: Balance =       1 * KWE;
	pub const MaxNativeTokenExistentialDeposit: Balance = 1000 * KWE;
...
parameter_types! {
	...
	pub const CandidacyDeposit: Balance =   1_000_000 * primitives::currency::KWE;
	pub const MinLockAmount: Balance =        100_000 * primitives::currency::KWE;
	pub const TotalLockedCap: Balance = 2_000_000_000 * primitives::currency::KWE;
}
